...
/********************       FILTER settings      *********************/
//Choose ONLY ONE option:
#define STAGE2FILTER    j            // Enable for smoother readings of voltage / current / RSSI. 
...
/********************       STARTUP settings      *********************/
#define INTRO_VERSION               "SkyHunt FireFighting System" // Call the OSD something else if you prefer. KVOSD is not permitted - LOL. 
...
/*-------------------------      Custom Settings              -----------------------------------------------------*/
#define AIMING_FIELD            //Uncomment to display 
#define AIMING_POS  224           //position of aiming crosshairs

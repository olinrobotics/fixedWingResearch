...
void displayAimingCrosshair(){
  uint16_t position = AIMING_POS;
  screen[position-1] = SYM_AH_CENTER_LINE;
  screen[position-2] = SYM_AH_CENTER_LINE;
  screen[position-3] = SYM_AH_CENTER_LINE;
  screen[position+1] = SYM_AH_CENTER_LINE_RIGHT;
  screen[position+2] = SYM_AH_CENTER_LINE_RIGHT;
  screen[position+3] = SYM_AH_CENTER_LINE_RIGHT;
  screen[position] =   SYM_AH_CENTER;
}
